...
export class UpdateLiquidityLimit__Params {
  ...
  get _original_balance(): BigInt {
    return this._event.parameters[1].value.toBigInt();
  }

  get _original_supply(): BigInt {
    return this._event.parameters[2].value.toBigInt();
  }

  get _working_balance(): BigInt {
    return this._event.parameters[3].value.toBigInt();
  }

  get _working_supply(): BigInt {
    return this._event.parameters[4].value.toBigInt();
  }
}

export class ChildChainLiquidityGaugeV2__reward_dataResultValue0Struct extends ethereum.Tuple {
...
export class ChildChainLiquidityGaugeV2 extends ethereum.SmartContract {
  static bind(address: Address): ChildChainLiquidityGaugeV2 {
    return new ChildChainLiquidityGaugeV2(
      "ChildChainLiquidityGaugeV2",
      address
    );
  }
  ...
  bal_token(): Address {
    let result = super.call("bal_token", "bal_token():(address)", []);

    return result[0].toAddress();
  }

  try_bal_token(): ethereum.CallResult<Address> {
    let result = super.tryCall("bal_token", "bal_token():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  try_bal_pseudo_minter(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "bal_pseudo_minter",
      "bal_pseudo_minter():(address)",
      []
  ...
  voting_escrow_delegation_proxy(): Address {
    let result = super.call(
  ...
  try_voting_escrow_delegation_proxy(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "voting_escrow_delegation_proxy",
      "voting_escrow_delegation_proxy():(address)",
      []
  ...
  try_authorizer_adaptor(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "authorizer_adaptor",
      "authorizer_adaptor():(address)",
      []
  ...
  reward_data(
    arg0: Address
  ): ChildChainLiquidityGaugeV2__reward_dataResultValue0Struct {
    let result = super.call(
      "reward_data",
      "reward_data(address):((address,uint256,uint256,uint256,uint256))",
      [ethereum.Value.fromAddress(arg0)]
    );
  ...
  > {
    ...
    return ethereum.CallResult.fromValue(
      changetype<ChildChainLiquidityGaugeV2__reward_dataResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
  ...
  inflation_rate(arg0: BigInt): BigInt {
    let result = super.call(
      "inflation_rate",
      "inflation_rate(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(arg0)]
    );
  ...
  try_inflation_rate(arg0: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "inflation_rate",
      "inflation_rate(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(arg0)]
...
export class ConstructorCall__Inputs {
  ...
  get _voting_escrow_delegation_proxy(): Address {
    return this._call.inputValues[0].value.toAddress();
  }

  get _bal_pseudo_minter(): Address {
    return this._call.inputValues[1].value.toAddress();
  }

  get _authorizer_adaptor(): Address {
...
export class Claim_rewards3Call extends ethereum.Call {
  get inputs(): Claim_rewards3Call__Inputs {
    return new Claim_rewards3Call__Inputs(this);
  }

  get outputs(): Claim_rewards3Call__Outputs {
    return new Claim_rewards3Call__Outputs(this);
  }
}

export class Claim_rewards3Call__Inputs {
  _call: Claim_rewards3Call;

  constructor(call: Claim_rewards3Call) {
    this._call = call;
  }
  ...
  get _reward_indexes(): Array<BigInt> {
    return this._call.inputValues[2].value.toBigIntArray();
  }
}

export class Claim_rewards3Call__Outputs {
  _call: Claim_rewards3Call;
