...
export class OptimismRootGaugeCreated extends ethereum.Event {
  get params(): OptimismRootGaugeCreated__Params {
    return new OptimismRootGaugeCreated__Params(this);
  }
}

export class OptimismRootGaugeCreated__Params {
  _event: OptimismRootGaugeCreated;

  constructor(event: OptimismRootGaugeCreated) {
    this._event = event;
  }
...
export class OptimismRootGaugeFactory extends ethereum.SmartContract {
  static bind(address: Address): OptimismRootGaugeFactory {
    return new OptimismRootGaugeFactory("OptimismRootGaugeFactory", address);
  }
