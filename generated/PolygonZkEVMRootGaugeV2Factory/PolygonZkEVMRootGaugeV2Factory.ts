...
export class PolygonZkEVMRootGaugeV2Factory extends ethereum.SmartContract {
  static bind(address: Address): PolygonZkEVMRootGaugeV2Factory {
    return new PolygonZkEVMRootGaugeV2Factory(
