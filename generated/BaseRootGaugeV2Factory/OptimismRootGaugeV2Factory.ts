...
export class OptimismRootGaugeV2Factory extends ethereum.SmartContract {
  static bind(address: Address): OptimismRootGaugeV2Factory {
    return new OptimismRootGaugeV2Factory(
      "OptimismRootGaugeV2Factory",
      address
    );
  }
