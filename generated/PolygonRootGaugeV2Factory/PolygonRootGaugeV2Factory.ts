...
export class PolygonRootGaugeV2Factory extends ethereum.SmartContract {
  static bind(address: Address): PolygonRootGaugeV2Factory {
    return new PolygonRootGaugeV2Factory("PolygonRootGaugeV2Factory", address);
  }
