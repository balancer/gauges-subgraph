...
export class ArbitrumRootGaugeV2Factory__getArbitrumFeesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class ArbitrumRootGaugeV2Factory extends ethereum.SmartContract {
  static bind(address: Address): ArbitrumRootGaugeV2Factory {
    return new ArbitrumRootGaugeV2Factory(
  ...
  getArbitrumFees(): ArbitrumRootGaugeV2Factory__getArbitrumFeesResult {
    ...
    return new ArbitrumRootGaugeV2Factory__getArbitrumFeesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getArbitrumFees(): ethereum.CallResult<
    ArbitrumRootGaugeV2Factory__getArbitrumFeesResult
  > {
    ...
    return ethereum.CallResult.fromValue(
      new ArbitrumRootGaugeV2Factory__getArbitrumFeesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
