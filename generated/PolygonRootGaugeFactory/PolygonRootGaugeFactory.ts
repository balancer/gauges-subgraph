...
export class PolygonRootGaugeCreated extends ethereum.Event {
  get params(): PolygonRootGaugeCreated__Params {
    return new PolygonRootGaugeCreated__Params(this);
  }
}

export class PolygonRootGaugeCreated__Params {
  _event: PolygonRootGaugeCreated;

  constructor(event: PolygonRootGaugeCreated) {
    this._event = event;
  }
...
export class PolygonRootGaugeFactory extends ethereum.SmartContract {
  static bind(address: Address): PolygonRootGaugeFactory {
    return new PolygonRootGaugeFactory("PolygonRootGaugeFactory", address);
  }
...
export class ConstructorCall__Inputs {
  ...
  get polygonRootChainManager(): Address {
    return this._call.inputValues[1].value.toAddress();
  }

  get polygonERC20Predicate(): Address {
