...
export class AvalancheRootGaugeV2Factory extends ethereum.SmartContract {
  static bind(address: Address): AvalancheRootGaugeV2Factory {
    return new AvalancheRootGaugeV2Factory(
